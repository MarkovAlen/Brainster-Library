...
<nav class="navbar navbar-expand-lg navbar-light bg-secondary">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <p class="navbar-text mb-0 mr-5"> <a href="./login/login.php"><button type="button"
                                                                             class="btn btn-warning text-white">Login</button></a></p>
        <p class="navbar-text mb-0 mr-5"> <a href="./register/register.php"><button type="button"
                                                                                   class="btn btn-warning text-white">Register</button></a></p>
    </div>
</nav>
<!-- NAVBAR  -->
<!-- BANNER  -->
                        ...
                        <div class="col-12 col-md-6 col-lg-4 book-card category-<?php echo $book['category_id']; ?>">
                            <div class="card" style="width: 10rem;">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="./book-index-details.php?book_id=<?php echo $book['id']; ?>" class="btn btn-primary px-4">Дознај повеќе</a>
                                    </div>
                                </div>
                            </div>
                        </div>
